...
– We strive to ease the pickup process for you in the case of returns. In most of the cases, we deliver the replacement while we do the pickup.<br>
– In a few other cases, we ensure that pickup is arranged at the earliest and we ship the replacement as soon as we receive the item from our courier partner.<br>
...
– The product is damaged due to misuse or Incidental damage due to malfunctioning of product.
– Products with tampered or missing serial numbers.<br>
– Made-to-order / custom orders<br></p><br>
<p class="text-justify">A return can also be created at the item level and if you have ordered multiple items, you can initiate a return for a partial quantity.</p>

<p class="text-justify">Once the item is received and quality meets our refund guidelines; thereafter, we will refund 100% amount to your account within 5- 7 working days.</p>

<p class="text-justify">In case you wish to retain the product; please call us to cancel your return request and we will do the needful. In case the replacement is already dispatched, you can reject the replacement item when it is delivered to you.</p>

<p class="text-justify"><b>* NOTE:</b> cancellation can be done within <b>24 hours</b>  of the order placed.</p>

<p class="text-justify">For International Orders, we would not be able to refund shipping charges, import duties, customs fees or local taxes paid.</p>

<p class="text-justify">We’re happy to answer any questions you have. Just call us <b>@ +91–9810-866-121 between 10 AM to 6 PM (Mon-Fri, IST)</b> .</p>
